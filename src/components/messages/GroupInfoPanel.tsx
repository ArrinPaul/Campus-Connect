...
export function GroupInfoPanel({ conversationId, onClose }: GroupInfoPanelProps) {
 ...
 className="w-full flex items-center gap-2 px-3 py-2 text-xs font-medium text-primary hover:bg-primary/10 rounded-lg"
 >
 ...
 className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-critical hover:bg-critical/10 rounded-lg border border-critical/30"
 >
