...
export function CreateGroupModal({ onClose, onCreated }: CreateGroupModalProps) {
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink-deep/20">
 <div className="w-full max-w-lg mx-4 bg-surface-soft rounded-xl shadow-2xl max-h-[85vh] flex flex-col">
 {/* Header */}
 ...
 maxLength={100}
 className="w-full px-3 py-2 text-sm rounded-lg border border-hairline bg-canvas text-ink-deep placeholder:text-slate focus:outline-none focus:ring-2 focus:ring-primary"
 />
 </div>
 ...
 rows={2}
 className="w-full px-3 py-2 text-sm rounded-lg border border-hairline bg-canvas text-ink-deep placeholder:text-slate focus:outline-none focus:ring-2 focus:ring-primary resize-none"
 />
 </div>
 ...
 className="w-full pl-9 pr-4 py-2 text-sm rounded-lg border border-hairline bg-canvas text-ink-deep placeholder:text-slate focus:outline-none focus:ring-2 focus:ring-primary"
 />
 </div>

 {/* Search Results */}
 {searchQuery.trim().length >= 2 && (
 <div className="mt-2 border border-hairline rounded-lg max-h-48 overflow-y-auto bg-surface-soft">
 {!searchResults ? (
 <div className="p-3 text-sm text-slate">Searching...</div>
 ) : filteredResults.length === 0 ? (
 <div className="p-3 text-sm text-slate">No users found</div>
 ) : (
 ...
 className="w-full flex items-center gap-3 p-3 hover:bg-canvas text-left"
 >
 {user.profilePicture ? (
 <Image
 ...
 {/* Footer */}
 <div className="flex items-center justify-end gap-3 p-4 border-t border-hairline">
 <button
 onClick={onClose}
 className="px-4 py-2 text-sm font-medium text-slate hover:text-ink-deep rounded-lg hover:bg-canvas"
 >
 Cancel
 </button>
 <button
