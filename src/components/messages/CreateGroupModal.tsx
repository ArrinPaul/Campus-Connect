...
export function CreateGroupModal({ onClose, onCreated }: CreateGroupModalProps) {
 ...
 <div className="w-full max-w-lg mx-4 bg-card rounded-lg shadow-2xl max-h-[85vh] flex flex-col">
 {/* Header */}
 ...
 maxLength={100}
 className="w-full px-3 py-2 text-sm rounded-lg border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
 />
 </div>
 ...
 rows={2}
 className="w-full px-3 py-2 text-sm rounded-lg border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary resize-none"
 />
 </div>
 ...
 className="w-full pl-9 pr-4 py-2 text-sm rounded-lg border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
 />
 </div>
 ...
 className="w-full flex items-center gap-3 p-3 hover:bg-card text-left"
 >
 {user.profilePicture ? (
 <Image
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground rounded-lg hover:bg-card"
 >
 Cancel
 </button>
 <button
