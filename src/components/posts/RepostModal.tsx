...
export function RepostModal({ post, isOpen, onClose, onSuccess }: RepostModalProps) {
 ...
 {/* Backdrop */}
 <div
 className="fixed inset-0 bg-ink-deep/20 z-40"
 onClick={handleClose}
 />
 ...
 className="px-4 py-2 text-sm font-medium text-on-primary bg-primary hover:bg-primary/90 rounded-md transition-colors disabled:opacity-50 flex items-center gap-2"
 >
 {isSubmitting && quoteContent && <ButtonLoadingSpinner />}
 Quote Post
 </button>
