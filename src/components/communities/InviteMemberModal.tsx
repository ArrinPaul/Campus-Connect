...
export function InviteMemberModal({ communityId, communityName, onClose }: InviteMemberModalProps) {
 ...
 <div className="h-9 w-9 rounded-full bg-primary text-on-primary flex items-center justify-center text-sm font-bold flex-shrink-0">
 ...
 disabled={isSending}
 className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium rounded-md bg-primary text-on-primary hover:bg-primary/90 disabled:opacity-50 transition-colors"
 >
 {isSending ? (
