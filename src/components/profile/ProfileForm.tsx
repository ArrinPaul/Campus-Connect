...
"Beginner" |"Intermediate" |"Advanced" |"Expert"
 ...
 {errors.image && (
 <p className="mt-1 text-sm text-critical">{errors.image}</p>
 )}
 </div>
 ...
 <span className="text-critical">{errors.bio}</span>
 ...
 />
 <div className="mt-1 flex justify-between text-sm">
 <span className="text-critical">{errors.university}</span>
 ...
 {errors.role && (
 <p className="mt-1 text-sm text-critical">{errors.role}</p>
 )}
 </div>
 ...
 <p className="mt-1 text-sm text-critical">{errors.experienceLevel}</p>
 )}
 </div>
 ...
 <div>
 {errors.submit && (
 <p className="mb-2 text-sm text-critical">{errors.submit}</p>
 )}
 {successMessage && (
 ...
 className="w-full rounded-md bg-primary px-4 py-2 text-on-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 flex items-center justify-center gap-2"
 >
