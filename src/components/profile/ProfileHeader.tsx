      ...
      <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-6">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <div className="mt-2 flex flex-wrap items-center justify-center gap-2 sm:justify-start">
            <span className="rounded-full bg-primary/10 dark:bg-blue-900 px-3 py-1 text-xs font-medium text-primary dark:text-blue-200 sm:text-sm">
              {user.role}
            </span>
            <span className="rounded-full bg-muted bg-muted px-3 py-1 text-xs font-medium text-foreground sm:text-sm">
            ...
            <div className="mt-3 flex flex-wrap justify-center gap-3 sm:mt-4 sm:justify-start">
              {user.socialLinks.github && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-md bg-muted bg-muted px-3 py-1.5 text-xs font-medium text-foreground hover:bg-muted dark:hover:bg-muted transition-colors"
              ...
              {user.socialLinks.linkedin && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 rounded-md bg-primary/10 dark:bg-blue-900/30 px-3 py-1.5 text-xs font-medium text-primary dark:text-blue-300 hover:bg-primary/10 dark:hover:bg-blue-900/50 transition-colors"
              ...
              {user.socialLinks.website && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 rounded-md bg-green-50 dark:bg-green-900/30 px-3 py-1.5 text-xs font-medium text-green-700 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-900/50 transition-colors"
        ...
        {!isOwnProfile && (
          <div className="flex-shrink-0 w-full sm:w-auto flex flex-col gap-2 sm:flex-row">
            ...
            <button
              ...
              className="w-full rounded-md px-6 py-2 text-sm font-medium text-primary bg-primary/10 hover:bg-primary/10 text-primary dark:bg-blue-900/30 dark:hover:bg-blue-900/50 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 sm:w-auto flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            ...
            <button 
              ...
              className={`w-full rounded-md px-6 py-2 text-sm font-medium text-primary-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 sm:w-auto flex items-center justify-center gap-2 ${
                isFollowing 
                  ? "bg-muted hover:bg-muted bg-muted dark:hover:bg-muted" 
