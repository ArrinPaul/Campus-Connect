...
export function PostJobModal({ onClose }: PostJobModalProps) {
 ...
 {skill}
 <button onClick={() => removeSkill(skill)} className="hover:text-critical">
 <X className="h-3 w-3" />
 </button>
 </span>
 ))}
 ...
 className="px-4 py-2 text-sm bg-primary text-on-primary rounded-lg hover:bg-primary/90 disabled:opacity-50"
 >
