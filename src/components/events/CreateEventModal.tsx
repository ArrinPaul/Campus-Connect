...
export function CreateEventModal({ onClose, communityId }: CreateEventModalProps) {
 ...
 <div className="w-full max-w-lg rounded-lg bg-card shadow-2xl overflow-y-auto max-h-[90vh]">
 {/* Header */}
 ...
 className="w-full rounded-lg border border-border bg-card bg-muted px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground dark:placeholder:text-muted-foreground focus:border-ring focus:outline-none focus:ring-1 focus:ring-primary"
 />
 </div>
 ...
 className="w-full rounded-lg border border-border bg-card bg-muted px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground dark:placeholder:text-muted-foreground focus:border-ring focus:outline-none focus:ring-1 focus:ring-primary resize-none"
 />
 </div>
 ...
 className="w-full rounded-lg border border-border bg-card bg-muted px-3 py-2 text-sm text-foreground focus:border-ring focus:outline-none focus:ring-1 focus:ring-primary"
 />
 </div>
 <div>
 <label className="block text-sm font-medium text-foreground mb-1">
