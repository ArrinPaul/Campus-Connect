...
export function MobileNav({ currentUserId }: MobileNavProps) {
 ...
 <div
 className={cn(
"fixed inset-0 z-40 bg-ink-deep/20 transition-opacity duration-300 md:hidden",
...
"flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-colors",
 ...
 totalUnread > 0 && (
 <span className="ml-auto flex h-5 min-w-[20px] items-center justify-center rounded-full bg-critical px-1.5 text-[10px] font-bold text-critical-foreground">
