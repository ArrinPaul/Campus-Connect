...
const JobCardSkeleton = () => (
  <div className="p-5 border border-border rounded-lg bg-card h-[150px] animate-pulse" />
);
    ...
    <div className="w-full bg-canvas min-h-screen pb-16">
      ...
      <section className="bg-card py-6 px-4 md:px-8 border-b border-border shadow-sm">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-heading-lg font-bold text-foreground mb-1">Job Board</h1>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link href="/jobs/my-applications">
              <button className="rounded-full border border-border bg-card px-4 py-2 text-xs font-semibold text-foreground hover:bg-canvas hover:border-primary/40 active:scale-[0.97] transition-all cursor-pointer">
                My Applications
              </button>
            </Link>
            <button
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative w-full md:max-w-md group">
              ...
              <input
                ...
                className="w-full pl-11 pr-10 h-11 rounded-full border border-border bg-card text-[15px] text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:bg-canvas transition-all shadow-sm"
              />
              {searchTerm && (
                <button
