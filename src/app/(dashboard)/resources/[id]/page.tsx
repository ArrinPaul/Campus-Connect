...
function ResourceDetailContent({ id }: { id: string }) {
 ...
 className="flex items-center gap-2 px-4 py-2.5 rounded-md bg-primary text-on-primary text-sm font-medium hover:bg-primary/90 disabled:opacity-50 transition-colors"
 >
 {isDownloading ? (
 <Loader2 className="h-4 w-4 animate-spin" />
 ) : (
