        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            {unreadCount !== undefined && unreadCount > 0 && (
              <span className="px-2.5 py-0.5 text-xs font-medium text-white bg-red-500 rounded-full">
                {unreadCount}
              </span>
            )}
          </div>
                ...
                {notificationsData.cursor && (
                  <div className="p-4 text-center border-t border-gray-200 dark:border-gray-700">
                    <button
                      ...
                      className="px-6 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors"
                    >
                      Load more
                    </button>
                  </div>
