...
export default function NotificationsPage() {
 ...
 {[...Array(5)].map((_, i) => (
 <div key={i} className="h-24 w-full bg-surface-soft animate-pulse rounded-lg" />
 ))}
 </div>
 </div>
 );
 ...
 <div className="p-6 rounded-full bg-surface-soft text-slate/20 mb-6">
 <Bell size={64} />
 </div>
 <h2 className="text-display-md text-ink-deep">Stay in the loop.</h2>
 <p className="text-body text-slate mt-2 max-w-xs">
 ...
 <h3 className="text-display-md text-ink-deep">All caught up.</h3>
 ...
 <div className="text-fine-print text-slate font-bold uppercase tracking-widest mb-2">
 ...
 <p className="text-fine-print text-slate font-semibold uppercase tracking-widest">End of Notifications</p>
 </div>
 </div>
 )}
 </div>
