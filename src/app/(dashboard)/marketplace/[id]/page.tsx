...
export default function ListingDetailPage({ params }: PageProps) {
 ...
 rows={3}
 maxLength={500}
 className="w-full rounded-md border bg-canvas p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 resize-none"
 />
 <div className="flex items-center gap-2 mt-3">
 <button
 onClick={handlePurchase}
 disabled={isPurchasing}
 className="flex items-center gap-1.5 px-4 py-2 rounded-md bg-primary text-on-primary text-sm font-medium hover:bg-primary/90 disabled:opacity-50"
 >
 {isPurchasing ? (
 ...
 className="h-10 px-4 active:scale-[0.98] border rounded-md text-sm font-semibold flex items-center gap-2 hover:bg-muted"
 >
 ...
 className="h-10 px-4 active:scale-[0.98] bg-green-500 text-white hover:bg-green-600 rounded-md text-sm font-semibold flex items-center gap-2 disabled:opacity-50"
 >
 ...
 disabled={isDeleting}
 className="h-10 px-4 active:scale-[0.98] border border-red-200 dark:border-red-900/50 text-red-600 rounded-md text-sm font-semibold flex items-center gap-2 hover:bg-red-500/10 disabled:opacity-50"
 >
 {isDeleting ? (
 <Loader2 className="h-4 w-4 animate-spin" />
 ) : (
