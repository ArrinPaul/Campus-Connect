...
const ListingCardSkeleton = () => (
  <div className="p-4 border border-border rounded-lg bg-card h-[300px] animate-pulse" />
);
    ...
    <div className="w-full bg-canvas min-h-screen pb-16">
      ...
      <section className="bg-card py-6 px-4 md:px-8 border-b border-border shadow-sm">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-heading-lg font-bold text-foreground mb-1">Marketplace</h1>
